...
func TestAnalytics_HourlyHandlerPassesResolvedSpeciesToDatastore(t *testing.T) {
	...
	mockDS.EXPECT().
		...
		RunAndReturn(func(_ context.Context, _ string, species string, _ ...uint) ([]datastore.HourlyAnalyticsData, error) {
...
func TestAnalytics_TimeOfDayDistributionResolvesLocalizedSpecies(t *testing.T) {
	...
	mockDS.EXPECT().
		...
		RunAndReturn(func(_ context.Context, _, _ string, species string, _ ...uint) ([]datastore.HourlyDistributionData, error) {
			capturedSpecies = species
...
func TestAnalytics_BatchDailySpeciesResolvesLocalizedSpecies(t *testing.T) {
	...
	mockDS.EXPECT().
		...
		RunAndReturn(func(_ context.Context, _, _, species string, _ ...uint) ([]datastore.DailyAnalyticsData, error) {
			capturedSpecies = species
